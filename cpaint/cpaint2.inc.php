...
//---- classes -----------------------------------------------------------------
  ...
  */
  class cpaint {
	...
	*/
	function __construct() {
	  ...
	  $this->complex_type([
		  ...
		  'values'    => [           // for type = 'restriction' only: list of allowed values
	  ...
	  $this->complex_type([
		  ...
		  'type'      => 'complex',
		  'struct'    => [
			0 => ['name' => 'functionName',  'type' => 'string'],
			1 => ['name' => 'responseType',  'type' => 'cpaintResponseType'],
			2 => ['name' => 'debugLevel',    'type' => 'cpaintDebugLevel'],
		  ],
		],
	  );
	  ...
	  $this->complex_type([
		  ...
		  'type'      => 'complex',
		  'struct'    => [
			0 => ['name' => 'success',  'type' => 'boolean'],
			1 => ['name' => 'debugger', 'type' => 'cpaintDebugMessage'],
		  ],
		],
	  );
	...
	* @return boolean
	*/
	function register($func, $input = [], $output = [], $comment = '') {
	  $return_value = false;
	  $input        = (array)   $input;
	  $output       = (array)   $output;
	...
	*/
	function complex_type($schema) {
	  ...
	  if ($schema['name'] != ''
		&& in_array($schema['type'], ['restriction', 'complex', 'list'])) {
